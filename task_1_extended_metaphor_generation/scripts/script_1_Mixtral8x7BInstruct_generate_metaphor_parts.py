# Script to generate schema and subvehicle metaphors with Mixtral8x7B Instruct hosted on Replicate
...
# Save every call
prompt_1_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_1_output")
prompt_2_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_2_output")
prompt_3_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_3_output")
prompt_4_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_4_output")
prompt_5_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_5_output")
prompt_6_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_6_output")
prompt_7_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_7_output")


# Consolidated to csv
prompt_1_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_1_output.csv")
prompt_2_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_2_output.csv")
prompt_3_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_3_output.csv")
prompt_4_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_4_output.csv")
prompt_5_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_5_output.csv")
prompt_6_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_6_output.csv")
prompt_7_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_7_output.csv")
