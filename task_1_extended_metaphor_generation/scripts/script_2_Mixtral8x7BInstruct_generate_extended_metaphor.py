# Script to run consolidated extended metaphor generation with Mixtral8x7B Instruct hosted on Replicate
...
# Save every call
prompt_use_relationships_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_use_relationships_output")
prompt_cover_subtensors_output_save_to_prefix = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_cover_subtensors_output")

# Consolidated to csv
prompt_use_relationships_extended_metaphors_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_use_relationships_extended_metaphors_output.csv")
prompt_cover_subtensors_extended_metaphors_output_save_to = pathlib.Path("../generations/script_run_Mixtral8x7BInstruct/prompt_cover_subtensors_extended_metaphors_output.csv")
